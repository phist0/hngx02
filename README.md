The api only accepts string values for name and email and for the id field only strings that can be cast to an integer between 1 and MAX integer supported by the system.
